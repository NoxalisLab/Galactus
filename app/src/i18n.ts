...
const dict: Record<string, { en: string; fr: string }> = {
  ...
  "pick.workspace": { en: "Choose the folder to work in", fr: "Choisir le dossier de travail" },
  "pick.root": { en: "Choose the Galactus folder", fr: "Choisir le dossier Galactus" },
  "pick.vault": { en: "Choose an Obsidian vault", fr: "Choisir un coffre Obsidian" },
  "pick.vaultNew": { en: "Choose where to create the vault", fr: "Choisir où créer le coffre" },
  "pick.knowledge": { en: "Choose a folder to index", fr: "Choisir un dossier à indexer" },
  "pick.export": { en: "Choose where to save the export", fr: "Choisir où enregistrer l'export" },
  "pick.generic": { en: "Choose a folder", fr: "Choisir un dossier" },
