...
const dict: Record<string, { en: string; fr: string }> = {
  ...
  // ---- team of sub-agents ----
  // Model teams (teams.ts, teamsview.ts). Role names are data, never keys here.
  // ---- learned decisions (learningview.ts) ----
  "learn.title": { en: "Learning", fr: "Apprentissage" },
  "learn.hint": { en: "Galactus learns its own task detection, on this Mac only", fr: "Galactus apprend sa propre détection de tâche, sur ce Mac uniquement" },
  "learn.intro": { en: "Off by default. Nothing is collected, downloaded or trained until you turn it on here. Traces stay on this Mac, secrets and credential paths are removed before they are written, and the built-in detection stays the fallback whenever the learned one is absent, slow or unsure.", fr: "Désactivé par défaut. Rien n'est collecté, téléchargé ni entraîné tant que tu ne l'actives pas ici. Les traces restent sur ce Mac, les secrets et chemins d'identifiants sont retirés avant l'écriture, et la détection intégrée reste le repli dès que la décision apprise est absente, lente ou incertaine." },
  "learn.collect": { en: "Collect traces", fr: "Collecter les traces" },
  "learn.collectHint": { en: "One redacted line per message: the text, the task detected, and what you did about it in the next two turns. Kept at most 10 000 lines or 90 days.", fr: "Une ligne expurgée par message : le texte, la tâche détectée et ce que tu en as fait dans les deux tours suivants. Au plus 10 000 lignes ou 90 jours." },
  "learn.count": { en: "%n traces on this Mac", fr: "%n traces sur ce Mac" },
  "learn.countOne": { en: "1 trace on this Mac", fr: "1 trace sur ce Mac" },
  "learn.toolkit": { en: "Learning toolkit", fr: "Outils d'apprentissage" },
  "learn.toolkitHint": { en: "A private Python environment and the base model, downloaded once with pinned hashes. Nothing is installed into the system Python.", fr: "Un environnement Python privé et le modèle de base, téléchargés une fois avec des empreintes figées. Rien n'est installé dans le Python du système." },
  "learn.install": { en: "Install", fr: "Installer" },
  "learn.installSize": { en: "Install (%s to download, about 1.6 GB on disk)", fr: "Installer (%s à télécharger, environ 1,6 Go sur le disque)" },
  "learn.cancel": { en: "Cancel", fr: "Annuler" },
  "learn.train": { en: "Train", fr: "Entraîner" },
  "learn.trainHint": { en: "The running model labels the traces, a small classifier is trained, then measured against the built-in detection on real traces it never saw: at least 60 test traces, so about 240 collected. It is used only if it wins.", fr: "Le modèle en cours étiquette les traces, un petit classifieur est entraîné puis mesuré face à la détection intégrée sur des traces réelles jamais vues : au moins 60 traces de test, soit environ 240 collectées. Il n'est utilisé que s'il gagne." },
  "learn.trainNow": { en: "Train now", fr: "Entraîner maintenant" },
  "learn.last": { en: "Last training", fr: "Dernier entraînement" },
  "learn.never": { en: "Never trained on this Mac.", fr: "Jamais entraîné sur ce Mac." },
  "learn.accepted": { en: "Accepted: it beat the built-in detection", fr: "Accepté : il bat la détection intégrée" },
  "learn.rejected": { en: "Rejected: kept on disk, the previous state stays", fr: "Refusé : gardé sur le disque, l'état précédent reste" },
  "learn.activeCkpt": { en: "In use: %s", fr: "En service : %s" },
  "learn.col.acc": { en: "Accuracy", fr: "Précision" },
  "learn.col.n": { en: "Test rows", fr: "Lignes de test" },
  "learn.col.ece": { en: "ECE", fr: "ECE" },
  "learn.row.student": { en: "Learned", fr: "Appris" },
  "learn.row.heuristic": { en: "Built-in", fr: "Intégré" },
  "learn.gate.n": { en: "at least %n test traces", fr: "au moins %n traces de test" },
  "learn.gate.gain": { en: "+%p points over built-in (%d)", fr: "+%p points sur l'intégré (%d)" },
  "learn.gate.ece": { en: "ECE at most %e", fr: "ECE au plus %e" },
  "learn.origin.teacher": { en: "Labels from the running model", fr: "Étiquettes du modèle en cours" },
  "learn.origin.outcome": { en: "Labels from your own corrections", fr: "Étiquettes issues de tes corrections" },
  "learn.origin.both": { en: "Labels from the running model and your corrections (yours win)", fr: "Étiquettes du modèle en cours et de tes corrections (les tiennes l'emportent)" },
  "learn.origin.hand": { en: "Labels from the shipped hand-labelled set only", fr: "Étiquettes du jeu livré annoté à la main uniquement" },
  "learn.labels": { en: "model %t · yours %o · shipped %h", fr: "modèle %t · les tiennes %o · livrées %h" },
  "learn.rollback": { en: "Roll back", fr: "Revenir en arrière" },
  "learn.rollbackHint": { en: "Use the previously accepted checkpoint again", fr: "Réutiliser le point de contrôle accepté précédemment" },
  "learn.rollbackTitle": { en: "Roll back the learned decision?", fr: "Revenir à la décision apprise précédente ?" },
  "learn.rollbackDetail": { en: "The checkpoint in use is replaced by the previous one (%s).", fr: "Le point de contrôle en service est remplacé par le précédent (%s)." },
  "learn.rolledBack": { en: "Previous checkpoint restored.", fr: "Point de contrôle précédent restauré." },
  "learn.use": { en: "Use the learned decision", fr: "Utiliser la décision apprise" },
  "learn.useHint": { en: "Below the confidence threshold, or after 50 ms without an answer, the built-in detection decides.", fr: "Sous le seuil de confiance, ou après 50 ms sans réponse, la détection intégrée décide." },
  "learn.threshold": { en: "Min. confidence", fr: "Confiance min." },
  "learn.traces": { en: "Traces", fr: "Traces" },
  "learn.tracesHint": { en: "Export them as JSON lines. “Delete traces” removes the traces only; “Erase everything” also removes every learned checkpoint and switches the learned decision off.", fr: "Les exporter en lignes JSON. « Supprimer les traces » n'efface que les traces ; « Tout effacer » efface aussi tous les modèles appris et désactive la décision apprise." },
  "learn.export": { en: "Export", fr: "Exporter" },
  "learn.exported": { en: "%n traces exported to %s", fr: "%n traces exportées vers %s" },
  "learn.clear": { en: "Delete traces", fr: "Supprimer les traces" },
  "learn.clearTitle": { en: "Delete every trace?", fr: "Supprimer toutes les traces ?" },
  "learn.clearDetail": { en: "%n traces are deleted from this Mac. Learned checkpoints already trained on them are NOT deleted: use “Erase everything” for that.", fr: "%n traces sont supprimées de ce Mac. Les modèles appris déjà entraînés dessus ne sont PAS supprimés : utilise « Tout effacer » pour cela." },
  ...
  "learn.forgetDetailOne": { en: "1 trace and every checkpoint trained on this Mac are deleted. The built-in detection takes over.", fr: "1 trace et tous les modèles entraînés sur ce Mac sont supprimés. La détection intégrée reprend la main." },
  ...
  "learn.rollbackFailed": { en: "Rolling back did not work.", fr: "Le retour en arrière n'a pas fonctionné." },
  "learn.exportFailed": { en: "The export did not work.", fr: "L'export n'a pas fonctionné." },
  "learn.settingFailed": { en: "The setting could not be saved.", fr: "Le réglage n'a pas pu être enregistré." },
  "learn.installFailed": { en: "The toolkit installation failed.", fr: "L'installation des outils a échoué." },
  ...
  "learn.block.fewTracesOne": { en: "1 trace so far, %m needed: the test needs at least 60 held-out traces, about a quarter of what is collected.", fr: "1 trace pour l'instant, %m nécessaires : le test exige au moins 60 traces de test mises de côté, environ un quart de ce qui est collecté." },
  ...
  "learn.block.noTeacher": { en: "Start a model first: it labels the traces.", fr: "Démarre d'abord un modèle : c'est lui qui étiquette les traces." },
  "learn.block.noCheckpoint": { en: "No trained checkpoint has passed the test yet.", fr: "Aucun point de contrôle entraîné n'a encore passé le test." },
  "learn.statusFailed": { en: "Learning status unavailable: %s", fr: "État de l'apprentissage indisponible : %s" },
  "learn.jobFailed": { en: "The learning job failed.", fr: "La tâche d'apprentissage a échoué." },
  "learn.toastAccepted": { en: "Training accepted: the learned decision is now available.", fr: "Entraînement accepté : la décision apprise est disponible." },
  "learn.toastRejected": { en: "Training rejected: it did not beat the built-in detection.", fr: "Entraînement refusé : il ne bat pas la détection intégrée." },
  "learn.phase.install": { en: "Preparing", fr: "Préparation" },
  "learn.phase.venv": { en: "Creating the environment", fr: "Création de l'environnement" },
  "learn.phase.requirements": { en: "Downloading packages", fr: "Téléchargement des paquets" },
  "learn.phase.download": { en: "Downloading", fr: "Téléchargement" },
  "learn.phase.checkpoint": { en: "Downloading the base model", fr: "Téléchargement du modèle de base" },
  "learn.phase.verify": { en: "Verifying", fr: "Vérification" },
  "learn.phase.label": { en: "Labelling", fr: "Étiquetage" },
  "learn.phase.train": { en: "Training", fr: "Entraînement" },
  "learn.phase.evaluate": { en: "Measuring", fr: "Mesure" },
  "teams.title": { en: "Model teams", fr: "Équipes de modèles" },
  "teams.hint": {
    en: "Several models working together: one plans, another writes the code",
    fr: "Plusieurs modèles travaillent ensemble : l'un planifie, l'autre code",
  },
  "teams.activeTitle": { en: "Active team", fr: "Équipe active" },
  "teams.activeHint": {
    en: "Teammates recruited for a role run on that role's model. Off: everything runs on the current model.",
    fr: "Les coéquipiers recrutés pour un rôle tournent sur le modèle de ce rôle. Désactivée : tout tourne sur le modèle en cours.",
  },
  "teams.off": { en: "Off", fr: "Désactivée" },
  "teams.active": { en: "Active", fr: "Active" },
  "teams.activate": { en: "Activate", fr: "Activer" },
  "teams.duplicate": { en: "Duplicate", fr: "Dupliquer" },
  "teams.reset": { en: "Reset", fr: "Réinitialiser" },
  "teams.delete": { en: "Delete", fr: "Supprimer" },
  "teams.name": { en: "Team name", fr: "Nom de l'équipe" },
  "teams.removeRole": { en: "Remove this role", fr: "Retirer ce rôle" },
  "teams.addRole": { en: "Add role", fr: "Ajouter le rôle" },
  "teams.rolePlaceholder": { en: "new role (reviewer…)", fr: "nouveau rôle (reviewer…)" },
  "teams.unavailable": { en: "unavailable here", fr: "indisponible ici" },
  "teams.unknownModel": { en: "not in the catalogue", fr: "absent du catalogue" },
  "teams.gbEstimated": { en: "GB estimated", fr: "Go estimés" },
  "teams.fits": { en: "fits this Mac (%b GB available)", fr: "tient sur ce Mac (%b Go disponibles)" },
  "teams.noFit": { en: "does not fit this Mac (%b GB available)", fr: "ne tient pas sur ce Mac (%b Go disponibles)" },
  "teams.fitUnknown": { en: "this Mac's memory is unknown", fr: "mémoire de ce Mac inconnue" },
  "teams.fitUnknownModel": {
    en: "cannot be estimated, unknown model: %s",
    fr: "estimation impossible, modèle inconnu : %s",
  },
  "teams.streamed": { en: "streamed from SSD: %s", fr: "en streaming SSD : %s" },
  "teams.none": { en: "No team preset in the catalogue.", fr: "Aucune équipe dans le catalogue." },
  "teams.copySuffix": { en: "(copy)", fr: "(copie)" },
  "teams.roleExists": { en: "The role %s already exists.", fr: "Le rôle %s existe déjà." },
  "teams.noRunnable": {
  ...
  "cloud.keyHint": {
    en: "Stored in the macOS Keychain, never shown again",
    fr: "Enregistrée dans le trousseau macOS, jamais réaffichée",
  },
  "cloud.keySaved": { en: "Key saved", fr: "Clé enregistrée" },
  "cloud.keyReplace": { en: "replace the key…", fr: "remplacer la clé…" },
  "cloud.keySave": { en: "Save", fr: "Enregistrer" },
  "cloud.keyClear": { en: "Remove", fr: "Supprimer" },
  "cloud.cap": { en: "Daily cap", fr: "Plafond quotidien" },
  "cloud.day": { en: "day", fr: "jour" },
  "cloud.spend": {
    en: "Today: $%t of $%c, %n calls",
    fr: "Aujourd'hui : %t $ sur %c $, %n appels",
  },
  "cloud.spendUnknown": { en: "Today's spend is unknown", fr: "Dépense du jour inconnue" },
  "cloud.redact": { en: "Mask secrets before sending", fr: "Masquer les secrets avant l'envoi" },
  "cloud.redactHint": {
  ...
  "cloud.redacted": {
    ...
    fr: "%n secret(s) masqué(s) avant l'envoi à %p.",
  },
  ...
  "sec.subtitle": {
    ...
    fr: "Auditer tes propres apps et machines. Lecture seule, rien n'est attaqué.",
  },
  "sec.webSect": { en: "Web endpoint", fr: "Point d'entrée web" },
  "sec.webHint": {
    en: "Headers, TLS and cookie flags of a site you host.",
    fr: "En-têtes, TLS et attributs de cookies d'un site que tu héberges.",
  },
  "sec.webPlaceholder": { en: "https://your-app.example", fr: "https://ton-app.exemple" },
  "sec.audit": { en: "Audit", fr: "Auditer" },
  "sec.auditing": { en: "Auditing...", fr: "Audit en cours..." },
  "sec.portSect": { en: "Open ports", fr: "Ports ouverts" },
  "sec.portHint": {
    en: "What is listening on a host you control. TCP connect, your assets only.",
    fr: "Ce qui écoute sur un hôte que tu contrôles. TCP connect, tes actifs seulement.",
  },
  "sec.hostPlaceholder": { en: "127.0.0.1 or build.local", fr: "127.0.0.1 ou build.local" },
  "sec.scan": { en: "Scan", fr: "Scanner" },
  "sec.scanning": { en: "Scanning...", fr: "Scan en cours..." },
  "sec.range": { en: "Ports", fr: "Ports" },
  "sec.rangeCommon": { en: "Common", fr: "Courants" },
  "sec.rangeAll": { en: "1-1024", fr: "1-1024" },
  "sec.noOpen": { en: "Nothing listening in that range.", fr: "Rien n'écoute dans cette plage." },
  "sec.noFindings": { en: "Reachable, but nothing to report.", fr: "Joignable, mais rien à signaler." },
  "sec.openPort": { en: "%p open", fr: "%p ouvert" },
  "sec.needHost": { en: "Name a host first.", fr: "Nomme d'abord un hôte." },
  "sec.needUrl": { en: "Give a full http:// or https:// URL.", fr: "Donne une URL http:// ou https:// complète." },
  "sec.own": {
    en: "Only your own machines. Naming one here is you saying it is yours.",
    fr: "Uniquement tes propres machines. En nommer une ici, c'est déclarer qu'elle est à toi.",
  },
  "img.subtitle": {
  ...
  "img.installTitle": { en: "%s is not on this Mac yet", fr: "%s n'est pas encore sur ce Mac" },
  "img.installHint": {
    en: "%g GB to download once. It stays on the disk and never goes back out.",
    fr: "%g Go à télécharger une fois. Il reste sur le disque et n'en ressort jamais.",
  },
  ...
  "img.model": { en: "Model", fr: "Modèle" },
  "img.size": { en: "Size", fr: "Taille" },
  "img.steps": { en: "Steps", fr: "Étapes" },
  "img.cfg": { en: "Guidance", fr: "Guidage" },
  "img.seed": { en: "Seed", fr: "Graine" },
  "img.generate": { en: "Generate", fr: "Générer" },
  "img.working": { en: "Working...", fr: "En cours..." },
  ...
  "img.save": { en: "Save to Downloads", fr: "Enregistrer dans Téléchargements" },
  "img.saved": { en: "Saved to Downloads: %s", fr: "Enregistré dans Téléchargements : %s" },
  ...
  "img.startFromMade": { en: "Use one made here", fr: "Utiliser une image générée" },
  ...
  "ssh.button": { en: "Machines", fr: "Machines" },
