...
CSV="${OUT}/qwen235-paliers-${STAMP}.csv"
...
MACHINES="${GALACTUS_MACHINES:-24 36 48 64 96 128}"
RECORD=11410916
LAYERS=94
...
echo ""
echo "=== banc petites machines — Qwen3-235B-A22B (137 Go d'experts) — ${STAMP} ==="
echo ""
for M in ${MACHINES}; do
  ...
  LOG="${OUT}/qwen235-mac${M}g-${STAMP}.log"
  GALACTUS_H4=1 \
  GALACTUS_PROFILE="${ROOT}/models/qwen3-235b-a22b/profile.engine.txt" \
